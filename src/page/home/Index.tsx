          ...
          <nav>
            ...
            <div className="icons">
              <img
                ...
                style={{
                  cursor: "pointer",
                  filter: activeSection === "main" ? "brightness(1000%)" : "brightness(70%)",
                }}
              />
              <img
                src={logo2}
                ...
                style={{
                  cursor: "pointer",
                  filter: activeSection === "movie" ? "brightness(1000%)" : "brightness(70%)",
                }}
              />
              <img
                src={logo3}
                ...
                style={{
                  cursor: "pointer",
                  filter: activeSection === "tvshow" ? "brightness(1000%)" : "brightness(70%)",
                }}
              />
              <img
                src={logo4}
                ...
                style={{
                  cursor: "pointer",
                  filter: activeSection === "bookmarks" ? "brightness(1000%)" : "brightness(70%)",
                }}
              />
            </div>
